...
namespace Hotel.Web.Models
{
    public class AddRoomViewModel
    {
        ...
        [System.Web.Mvc.Remote( "CheckRoomNumber", "Room" )]
        ...
        [Required( ErrorMessage = requiredField )]
        [Range( typeof( int ), "1", "2", ErrorMessage = "Room can hold only one or two persons" )]
        public int PersonsCount { get; set; }

        [Required( ErrorMessage = requiredField )]
        [Range( typeof( int ), "1", "2", ErrorMessage = "Room can hold only one or two beds" )]
